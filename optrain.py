...
CFG_LIST = {
    "light": dict(iterations=250, depth=6,  lr=0.08,  n_sample=5_000_000,  n_splits=3),
    "mid":   dict(iterations=500, depth=8,  lr=0.05,  n_sample=10_000_000, n_splits=5),
    "pro":   dict(iterations=800, depth=10, lr=0.035, n_sample=10_000_000, n_splits=5)
}
COMMON = dict(
    eval_metric="AUC",
    random_seed=42,
